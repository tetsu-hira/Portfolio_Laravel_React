...
const Item: React.FC = () => {
  ...
  const handle1setPoint = (index: number, point: number) => {
    ...
    console.log('indexは');
    console.log(index);
    Plan[index].time1 = point + Plan[index].time1;
  ...
  const handle2setPoint = (index: number, point: number) => {
    ...
    console.log(Plan[index]);
    Plan[index].time2 = point + Plan[index].time2;
                  ...
                  <div className='FlexCount'>
                    {index % 2 !== 0 && (
                      <div className='FlexCount__Button'>
                        <button className='AddCount top' onClick={() => handle1setPoint(index, 5)}>
                          +
                        </button>
                        <button className='SubCount top' onClick={() => handle1setPoint(index, -1)}>
                          -
                        </button>
                      </div>
                    )}
                    {index % 2 !== 0 && (
                      <div className='FlexCount__Button'>
                        <button
                          ...
                          onClick={() => handle2setPoint(index, 5)}
                        >
                          <div className='operator'>+</div>
                        </button>
                        <button
                          className='SubCount bottom'
                          onClick={() => handle2setPoint(index, -1)}
                        >
                          <div className='operator'>-</div>
                        </button>
                      </div>
